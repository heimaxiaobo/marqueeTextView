...
public class MarqueeText extends View implements Runnable {
    ...
    private void initattrs(AttributeSet attrs) {
        ...
        textColor = tta.getColor(R.styleable.MarqueeText_marqueeview_text_color, textColor);
        isClickStop = tta.getBoolean(R.styleable.MarqueeText_marqueeview_isclickalbe_stop, isClickStop);
        isResetLocation = tta.getBoolean(R.styleable.MarqueeText_marqueeview_is_resetLocation, isResetLocation);
        speed = tta.getFloat(R.styleable.MarqueeText_marqueeview_text_speed, speed);
        textSize = tta.getFloat(R.styleable.MarqueeText_marqueeview_text_size, textSize);
        textDistance1 = tta.getInteger(R.styleable.MarqueeText_marqueeview_text_distance, textDistance1);
        startLocationDistance = tta.getFloat(R.styleable.MarqueeText_marqueeview_text_startlocationdistance, startLocationDistance);
        repetType = tta.getInt(R.styleable.MarqueeText_marqueeview_repet_type, repetType);
        tta.recycle();
    }
